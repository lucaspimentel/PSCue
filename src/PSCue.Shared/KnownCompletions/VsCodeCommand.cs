...
public static class VsCodeCommand
{
    public static Command Create()
    {
        return new Command("code")
        {
            Parameters =
            [
                new("--diff", "Compare two files with each other (-d)") { Alias = "-d" },
                new("--merge", "Perform a three-way merge by providing paths for two modified versions of a file, the common origin of both modified versions and the output file to save merge results (-m)") { Alias = "-m" },
                new("--add", "Add folder(s) to the last active window (-a)") { Alias = "-a" },
                new("--remove", "Remove folder(s) from the last active window."),
                new("--goto", "Open a file at the path on the specified line and character position (-g)") { Alias = "-g" },
                new("--new-window", "Force to open a new window (-n)") { Alias = "-n" },
                new("--reuse-window", "Force to open a file or folder in an already opened window (-r)") { Alias = "-r" },
                new("--wait", "Wait for the files to be closed before returning (-w)") { Alias = "-w" },
                ...
                new("--help", "Print usage (-h)") { Alias = "-h" },
                ...
                new("--status", "Print process usage and diagnostics information (-s)") { Alias = "-s" },
