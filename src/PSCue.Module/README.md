...
### NuGet Packages
- `Microsoft.PowerShell.SDK` - PowerShell SDK for ICommandPredictor and IFeedbackProvider
- `Microsoft.Data.Sqlite` - SQLite database for persistence

See `PSCue.Module.csproj` for exact pinned versions.
